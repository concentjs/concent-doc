...
<link type="text/css" rel="stylesheet" href="/my-styleg.css" />
...
<div style="display:flex; justify-content:flex-start; flex-flow: row wrap;">
  ...
  <div style="width:25%; padding:0 10px; text-align:center">
    <div class="featureImgBase featureImg4"></div>
    <h2>灵活的数据消费粒度</h2>
    <p style="text-align:left;color:#697b8c; font-size:16px; line-height:22px">
  ...
  <div style="width:25%; padding:0 10px; text-align:center">
    <div class="featureImgBase featureImg5"></div>
    <h2>渐进式</h2>
    <p style="text-align:left;color:#697b8c; font-size:16px; line-height:22px">
  ...
  <div style="width:25%; padding:0 10px; text-align:center">
    <div class="featureImgBase featureImg6"></div>
    <h2>组件能力增强</h2>
    <p style="text-align:left;color:#697b8c; font-size:16px; line-height:22px">
  ...
  <div style="width:25%; padding:0 10px; text-align:center">
    <div class="featureImgBase featureImg7"></div>
    <h2>高度一致的编程体验</h2>
    <p style="text-align:left;color:#697b8c; font-size:16px; line-height:22px">
  ...
  <div style="width:25%; padding:0 10px; text-align:center">
    <div class="featureImgBase featureImg8"></div>
    <h2>渲染性能出众</h2>
    <p style="text-align:left;color:#697b8c; font-size:16px; line-height:22px">
  ...
  <div style="width:25%; padding:0 10px; text-align:center">
    <div class="featureImgBase featureImg9"></div>
    <h2>干净的dom层级</h2>
    <p style="text-align:left;color:#697b8c; font-size:16px; line-height:22px">
  ...
  <div style="width:25%; padding:0 10px; text-align:center">
    <div class="featureImgBase featureImg10"></div>
    <h2>支持扩展中间件与插件</h2>
    <p style="text-align:left;color:#697b8c; font-size:16px; line-height:22px">
  ...
  <div style="width:25%; padding:0 10px; text-align:center">
    <div class="featureImgBase featureImg11"></div>
    <h2>去中心化的动态配置模块</h2>
    <p style="text-align:left;color:#697b8c; font-size:16px; line-height:22px">
  ...
  <div style="width:25%; padding:0 10px; text-align:center">
    <div class="featureImgBase featureImg12"></div>
    <h2>模块克隆</h2>
    <p style="text-align:left;color:#697b8c; font-size:16px; line-height:22px">
